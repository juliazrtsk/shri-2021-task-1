...
const VoteSlide = props => {
  ...
  const renderedUsers = users.slice(0, 6).map((user, index // Todo: use offset?
  ) =>
  /*#__PURE__*/
  react.createElement(userCard_UserCard, {
  ...
  const renderButton = dir => /*#__PURE__*/react.createElement(arrowButton_ArrowButton, {
  ...
  return /*#__PURE__*/react.createElement(slideLayout_SlideLayout, {
    ...
    className: "vote"
  }, renderButton(arrowButtonDirections.up), renderedUsers, renderButton(arrowButtonDirections.down)));
};
...
function renderTemplate(alias, data) {
  ...
  return server_browser_default().renderToString(slide);
}
